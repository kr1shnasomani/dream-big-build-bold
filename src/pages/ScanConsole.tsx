...
const scanPhases: ScanPhase[] = [
  {
    ...
    duration: 4,
    logLines: [
      '> Initiating DNS enumeration for *.pnb.co.in ...',
      '  [+] Found: pnb.co.in (A: 14.140.82.10)',
      '  [+] Found: netbanking.pnb.co.in (A: 14.140.82.25)',
      '  [+] Found: vpn.pnb.co.in (A: 14.140.82.10)',
      '  [+] Found: auth.pnb.co.in (A: 14.140.82.40)',
      '  [+] Found: swift.pnb.co.in (A: 14.140.82.20)',
      '  [+] Found: mail.pnb.co.in (A: 14.140.82.32)',
      '  [+] Found: pqc-api.pnb.co.in (A: 14.140.82.50)',
      '  [!] Shadow IT: dev-api.pnb.co.in (external registrar)',
      '  [!] Shadow IT: test-portal.pnb.co.in (unknown owner)',
  ...
  },
  {
    ...
    logLines: [
      ...
      '  [SCAN] vpn.pnb.co.in:443 — TLS 1.2 | RSA-2048 | AES-128-CBC',
      '  [WARN] vpn.pnb.co.in — TLS 1.0, 1.1 enabled (legacy)',
      '  [WARN] vpn.pnb.co.in — No forward secrecy (RSA key exchange)',
      '  [SCAN] netbanking.pnb.co.in:443 — TLS 1.2 | ECDHE-RSA | AES-256-GCM',
      '  [SCAN] auth.pnb.co.in:443 — TLS 1.3 | X25519 | AES-256-GCM',
      '  [SCAN] swift.pnb.co.in:443 — TLS 1.2 | ECDHE-RSA | AES-256-GCM',
      '  [CRIT] staging.pnb.co.in:443 — No TLS response (connection refused)',
      '  [SCAN] pqc-api.pnb.co.in:443 — TLS 1.3 | X25519MLKEM768 | AES-256-GCM',
      '  [OK]   pqc-api.pnb.co.in — PQC hybrid key exchange detected!',
  ...
  },
  {
    ...
    logLines: [
      ...
      '  [HNDL] vpn.pnb.co.in — Break Year: 2031 (5 years) — CRITICAL',
      '  [HNDL] netbanking.pnb.co.in — Break Year: 2034 (8 years) — HIGH',
      '  [HNDL] auth.pnb.co.in — Break Year: 2038+ (12+ years) — LOW',
      '  [HNDL] pqc-api.pnb.co.in — Quantum-Safe (ML-KEM-768)',
